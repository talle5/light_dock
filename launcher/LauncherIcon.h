...
namespace unity::shell
{
    ...
    public:
        // Removido geo, m_app_id, m_is_running pois já estão na classe base Icon
        ...
        // Usando os setters da classe base
        ...
        {
            // Lógica de ativação (pode ser movida para o Launcher/Docky se preferir DOD)
        }
        ...
        void Draw(Renderer2D& renderer) override
        {
            ...
            // Usamos geo (da classe base) para as dimensões
            ...
            renderer.DrawTexture(
                geo.x + logo_padding,
                geo.y + logo_padding,
                geo.w - (logo_padding * 2.0f),
                geo.h - (logo_padding * 2.0f),
                tex_logo);
            ...
            if (m_running)
            {
                ...
                renderer.DrawSquircle(dot_x, dot_y, dot_size, dot_size,
                                      1.0f, 1.0f, 1.0f, 0.9f, dot_size / 2.0f);
            }
        }

    private:
        void DrawContextMenu(Renderer2D& renderer)
        {
            float menu_w = 180.0f;
            float menu_h = 100.0f;
            ...
            renderer.DrawRect(menu_x + 5.0f, menu_y + 10.0f, menu_w - 10.0f, 35.0f, 0.2f, 0.2f, 0.25f, 0.8f);
            renderer.DrawRect(menu_x + 5.0f, menu_y + 55.0f, menu_w - 10.0f, 35.0f, 0.2f, 0.2f, 0.25f, 0.8f);
        }
    };
} // namespace unity::shell
