...
namespace nux
{
    ...
    public:
        ...
        {
            return !((r.x > x + w) || (r.x + r.w < x) || (r.y > y + h)
                || (r.y + r.h < y));
        }
        ...
        {
            return {
                this->x + rhs.x, this->y + rhs.y, this->w + rhs.w,
                this->h + rhs.h
            };
        }
        ...
        {
            return {
                static_cast<int>(this->x * scalar), static_cast<int>(this->y * scalar),
        ...
        [[nodiscard]] Point2D<float> GetCenter() const
        {
            return Point2D<float>(x + w / 2, y + h / 2);
        }
