...
public:
    ...
    float* GetOrthoMatriz()
    {
        return ortomatrix.data();
    }
...
private:
    void InitShaders()
    {
        ...
        m_texShader.LoadFromFile( "vertex.vert",  "texture.frag");
        m_rectShader.LoadFromFile( "vertex.vert",  "rect.frag");
        m_squircleShader.LoadFromFile( "vertex.vert",  "squircle.frag");
        m_shineShader.LoadFromFile( "vertex.vert",  "icon_shine.frag");
    }

public:
    void SetSize(int w,int h)
    {
        ortomatrix= MakeOrthoMatrix(w,h);
    }
